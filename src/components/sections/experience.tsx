...
const experiences = [
  {
    role: "C/C++, Web Technology, Project Development",
    period: "Feb 2026 - Present",
    company: "ATMS Group of Institute Hapur",
    icon: <GraduationCap className="w-5 h-5 text-neon-blue" />,
    glowColor: "rgba(0, 240, 255, 0.25)",
    points: [
      "Conducting theoretical and practical lab sessions.",
      "Preparing lesson plans, assignments, and examination materials.",
      "Guiding students in academic projects and programming practices.",
      "Providing hands-on training in HTML, CSS, JavaScript, and modern web technologies.",
      "Monitoring student performance and offering academic support.",
      "Participating in departmental activities, workshops, and curriculum development.",
    ],
  },
  {
    role: "UI/UX & Frontend Developer",
    period: "Feb 2026 - Present",
    company: "DevforDevs (Figma Design, Next JS, Tailwind CSS)",
    icon: <Code2 className="w-5 h-5 text-neon-purple" />,
    glowColor: "rgba(168, 85, 247, 0.25)",
    points: [
      "Refined the overall design language to create a consistent and professional visual identity aligned with fintech aesthetics.",
      "Enhanced the color palette balance for better brand contrast and visual harmony.",
      "Reorganized content hierarchy to make information flow more intuitive and scannable.",
      "Removed excessive white spaces and balanced padding/margin for a neat, compact layout.",
      "Enhanced form design with clear input fields, validation, and visual feedback.",
    ],
  },
  {
    role: "Senior Web Developer",
    period: "Jan 2025 - Present",
    company: "Krapton IT Consultancy (Uttam Nagar, Delhi)",
    icon: <Briefcase className="w-5 h-5 text-neon-pink" />,
    glowColor: "rgba(236, 72, 153, 0.25)",
    points: [
      "Removed unwanted white spaces and gaps between sections for a cleaner visual flow. Aligned content grids and sections properly for better visual symmetry.",
      "Reduced visual noise by removing unnecessary elements and focusing on core content. Improved animation timing and transitions for smoother UI interaction.",
      "Compressed images and optimized assets for faster loading speed. Cleaned up unused CSS and scripts to improve overall site performance. Used modern CSS layout methods (Flexbox, Grid) for efficiency and cleaner code.",
    ],
  },
  {
    role: "UI/UX Designer",
    period: "July 2023 - Dec 2024",
    company: "Chetu Inc. (Noida, India)",
    icon: <Briefcase className="w-5 h-5 text-emerald-400" />,
    glowColor: "rgba(52, 211, 153, 0.25)",
    points: [
      "Utilizing Figma, I create wireframes and designs, which I then convert into HTML code for development. I manage projects with UI challenges in the project management pool, ensuring timely resolutions and maintaining project timelines.",
      "My work with React.js includes creating components, fetching APIs, and ensuring smooth client interactions throughout the application. I focus on resolving UI issues for high-priority tasks, ensuring that user experience remains a top priority.",
    ],
  },
];
