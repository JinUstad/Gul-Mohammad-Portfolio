...
const skillCategories = [
  {
    ...
    skills: ["HTML", "CSS", "Bootstrap 5", "Tailwind CSS", "JavaScript", "Figma", "Adobe XD", "React JS", "Redux Tool Kit", "API Integration", "Strapi", "C/C++"],
  },
  {
  ...
  },
  {
    ...
    skills: ["Chat GPT", "Canva", "Figma", "VS Code", "Wonder Share Filmora", "GitHub"],
  },
  {
    title: "Concepts",
